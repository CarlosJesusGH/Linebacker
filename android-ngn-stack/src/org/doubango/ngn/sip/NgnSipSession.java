...
public abstract class NgnSipSession extends NgnObservableObject implements Comparable<NgnSipSession> {
     ...
     * @sa @ref removeHeader()
     * @code mSipSession.addHeader("User-Agent", "IM-OMAv1.0");
     * @endcode
     */
     ...
     * @return true if succeed and false otherwise
     * @sa @ref addHeader()
     * @code mSipSession.removeHeader("User-Agent");
     * @endcode
     */
     ...
     * @return true if succeed and false otherwise
     * @sa @ref removeCaps()
     * @code mSipSession.addCaps("+g.3gpp.smsip");
     * @endcode
     */
     ...
     * @return true if succeed and false otherwise
     * @sa @ref removeCaps()
     * @code mSipSession.addCaps("+g.3gpp.icsi-ref", "\"urn%3Aurn-7%3A3gpp-service.ims.icsi.mmtel\"");
     * @endcode
     */
     ...
     * @return true if succeed and false otherwise
     * @sa @ref addCaps()
     * @code mSipSession.removeCaps("+g.3gpp.smsip");
     * @endcode
     */
