 ...
 * @code final INgnHistoryService mHistoryService = NgnEngine.getInstance().getHistoryService();
 * @endcode
 */
public interface INgnHistoryService extends INgnBaseService {
     ...
     * @code // Delete all "File Transfer" events stored in the history list
     ...
     * @Override public boolean apply(NgnHistoryEvent event) {
