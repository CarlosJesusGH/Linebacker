 ...
 * @code final INgnSipService mSipService = NgnEngine.getInstance().getSipService();
 * @endcode <h1>Audio/Video calls</h1>
 ...
 * @code final String remoteUri = "+33600000000";
 ...
 * }
 * @endcode <h2>Making video call</h2>
 * To get notified about the audio/video call state please see @ref anchor_Listening_for_audio_video_call_state "here"<br/>
 * @code final String remoteUri = "+33600000000";
 * final String validUri = NgnUriUtils.makeValidSipUri(remoteUri); // sip:+33600000000"@doubango.org
 ...
 * Log.e(TAG,"Failed to place the call");
 * }
 * @endcode <h1>SMS and Chat</h1>
 * <h2>3GPP Binary SMS</h2>
 * @code final String SMSC = "sip:+3310000000@doubango.org"; // SMS Center
 ...
 * @endcode <h2>Pager Mode IM</h2>
 * @code final String textToSend = "hello world!";
 * final String remotePartyUri = "sip:+336000000@doubango.org"; // remote party
 * final NgnMessagingSession imSession = NgnMessagingSession.createOutgoingSession(mSipService.getSipStack(),
 * remotePartyUri);
 ...
 * // release session
 * NgnMessagingSession.releaseSession(imSession);
 * @endcode <h1>Listening to events</h1>
 ...
 * @code final TextView mTvInfo = (TextView)findViewById(R.id.textViewInfo);
 ...
 * @endcode <h2>Listening for audio/video call state change</h2>
 ...
 * @code final BroadcastReceiver mSipBroadCastRecv = new BroadcastReceiver() {
 * @Override public void onReceive(Context context, Intent intent) {
 * InviteState state;
 * final String action = intent.getAction();
 ...
 * @code final INgnConfigurationService mConfigurationService = NgnEngine.getInstance().getConfigurationService();
 * @endcode <h3>Realm</h3>
 ...
 * @code final String myIMPI = "33446677887";
 * final boolean bSaveNow = true;
 * mConfigurationService(ConfigurationEntry.IDENTITY_IMPI, myIMPI, bSaveNow);
 * @endcode <h3>IMS Public Identity (IMPU)</h3>
