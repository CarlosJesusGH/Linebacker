...
public class IntentServiceUpload extends IntentService {
    ...
    private static final String SERVICE_NAME = IntentServiceUpload.class.getName();
    ...
    private static ImageView mHiddenView;
     ...
     */
    public static void startUpload(final UploadRequest task, ImageView pHiddenView)
        ...
        if (task == null) {
            ...
            final Intent intent = new Intent(task.getContext(), IntentServiceUpload.class);
        ...
        if (intent != null) {
            ...
            if (ACTION_UPLOAD.equals(action)) {
                ...
                try {
                    ...
                    wakeLock.release();
                    if(mHiddenView != null) {
                        // This can't be done because the IntentService runs on a different service from that which created the View
