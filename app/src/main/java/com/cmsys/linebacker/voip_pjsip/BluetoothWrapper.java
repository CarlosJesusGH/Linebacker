    ...
    public static BluetoothWrapper getInstance(Context context) {
        if (instance == null) {
            if (Compatibility.isCompatible(14)) {
                instance = new com.cmsys.linebacker.voip_pjsip.BluetoothUtils14();
            } else if (Compatibility.isCompatible(8)) {
                instance = new com.cmsys.linebacker.voip_pjsip.BluetoothUtils8();
            } else {
                instance = new com.cmsys.linebacker.voip_pjsip.BluetoothUtils3();
            }
            if (instance != null) {
