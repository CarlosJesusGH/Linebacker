...
public class Engine extends NgnEngine {
    ...
    private INgnBaseService mScreenService;
...
//		final Notification notification = new Notification(R.mipmap.ic_helmet, "", System.currentTimeMillis());
...
//
        ...
        switch (notifId) {
            ...
            case NOTIF_CONTSHARE_ID:
                intent.putExtra("action", CallScreenActivity.ACTION_SHOW_CONTSHARE_SCREEN);
            ...
            case NOTIF_SMS_ID:
                ...
                intent.putExtra("action", CallScreenActivity.ACTION_SHOW_SMS);
                break;
            ...
            case NOTIF_CHAT_ID:
                ...
                intent.putExtra("action", CallScreenActivity.ACTION_SHOW_CHAT_SCREEN);
                break;
        ...
        NotificationCompat.Builder builder = MessageUtils.notification(IMSDroid.getContext(), "LINEBACKER", tickerText, notifId, null, null, false, null, false);
    ...
    public INgnBaseService getScreenService() {
        if (mScreenService == null) {
            mScreenService = new INgnBaseService() {
                @Override
                public boolean start() {
                    Log.d(TAG, "starting...");
                    return false;
